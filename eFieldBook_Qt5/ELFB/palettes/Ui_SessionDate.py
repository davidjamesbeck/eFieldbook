# Form implementation generated from reading ui file 'ELFB/palettes/SessionDate.ui'
#
...
class Ui_SessionDateManager(object):
    def setupUi(self, SessionDateManager):
        ...
        self.label = QtWidgets.QLabel(parent=SessionDateManager)
        self.label.setObjectName("label")
        self.horizontalLayout_2.addWidget(self.label)
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName("verticalLayout")
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=SessionDateManager)
