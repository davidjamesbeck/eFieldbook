# Form implementation generated from reading ui file 'ELFB/palettes/GrammarManager.ui'
#
...
class Ui_gManager(object):
    def setupUi(self, gManager):
        ...
        self.lexBox = QtWidgets.QGroupBox(parent=gManager)
        ...
        self.label = QtWidgets.QLabel(parent=self.lexBox)
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.lexBox)
        ...
        self.label_3 = QtWidgets.QLabel(parent=self.lexBox)
        ...
        self.textEdit = QtWidgets.QTextEdit(parent=self.lexBox)
        self.textEdit.setGeometry(QtCore.QRect(15, 338, 380, 36))
        self.textEdit.setObjectName("textEdit")
        self.groupBox_2 = QtWidgets.QGroupBox(parent=gManager)
...
"}")
        ...
        self.Del = QtWidgets.QPushButton(parent=self.groupBox_2)
        ...
        self.Clear = QtWidgets.QPushButton(parent=self.groupBox_2)
