# Form implementation generated from reading ui file 'ELFB/palettes/LinkToLexicon.ui'
#
...
class Ui_EntryManager(object):
    def setupUi(self, EntryManager):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=EntryManager)
        self.groupBox.setGeometry(QtCore.QRect(10, 9, 380, 400))
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.lexList = QtWidgets.QTreeWidget(parent=self.groupBox)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=EntryManager)
