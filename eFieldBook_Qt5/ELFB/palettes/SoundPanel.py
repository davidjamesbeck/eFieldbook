...
from PyQt5 import QtWidgets, QtGui, QtCore,  QtMultimedia,  QtNetwork
...
class SoundPanel(QtWidgets.QWidget, Ui_SoundPanel):
        ...
        if msgbox.result() == QtWidgets.QMessageBox.Ok:
            ...
            if address[0] == "L":
                ...
                if QtCore.QObject.objectName(QtCore.QObject.parent(self)) == 'lexicon':
                    ...
                    elif lexNode.find('C2[@MediaRef="%s"]'%medID) != None:
    ...
    def newMedia(self):
        ...
        if newFile.exec_():
            ...
            newPath = newNames[0]
            if dataIndex.root.get("MediaFolder") == None or dataIndex.root.get("MediaFolder") != path.dirname(newPath):
            ...
            self.Recordings.setCurrentIndex(self.Recordings.findText(newName,QtCore.Qt.MatchExactly))
