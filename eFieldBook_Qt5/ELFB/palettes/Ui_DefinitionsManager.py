# Form implementation generated from reading ui file 'ELFB/palettes/DefinitionsManager.ui'
#
...
"}")
        ...
        self.fieldBox = QtWidgets.QGroupBox(parent=Dialog)
        ...
        self.addEgBtn = QtWidgets.QToolButton(parent=self.fieldBox)
        ...
        self.minusEgBtn = QtWidgets.QToolButton(parent=self.fieldBox)
        ...
        self.diaBox = QtWidgets.QGroupBox(parent=self.fieldBox)
        ...
        self.Clear = QtWidgets.QPushButton(parent=self.fieldBox)
        self.Clear.setGeometry(QtCore.QRect(367, 548, 55, 24))
        self.Clear.setObjectName("Clear")
        self.Update = QtWidgets.QPushButton(parent=self.fieldBox)
        self.Update.setGeometry(QtCore.QRect(437, 548, 55, 24))
        self.Update.setObjectName("Update")
        self.SLanguage_2 = QtWidgets.QLabel(parent=self.fieldBox)
        ...
        self.OkayBtn = QtWidgets.QPushButton(parent=Dialog)
