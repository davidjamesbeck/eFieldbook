# Form implementation generated from reading ui file 'ELFB/palettes/AbbrManager.ui'
#
...
class Ui_AbbrManager(object):
    def setupUi(self, AbbrManager):
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=AbbrManager)
        self.buttonBox.setGeometry(QtCore.QRect(140, 141, 202, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Cancel|QtWidgets.QDialogButtonBox.StandardButton.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.groupBox = QtWidgets.QGroupBox(parent=AbbrManager)
        ...
        self.abbreviation = QtWidgets.QTextEdit(parent=self.formLayoutWidget)
        ...
        self.gloss = QtWidgets.QTextEdit(parent=self.formLayoutWidget)
        ...
        self.form = QtWidgets.QTextEdit(parent=self.formLayoutWidget)
        ...
        self.updateCheckbox = QtWidgets.QCheckBox(parent=AbbrManager)
