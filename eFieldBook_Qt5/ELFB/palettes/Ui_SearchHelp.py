# Form implementation generated from reading ui file 'ELFB/palettes/SearchHelp.ui'
#
...
class Ui_SearchHelpDialog(object):
    def setupUi(self, SearchHelpDialog):
        ...
        self.helpText = QtWidgets.QTextEdit(parent=SearchHelpDialog)
        self.helpText.setGeometry(QtCore.QRect(14, 12, 481, 509))
        self.helpText.setObjectName("helpText")
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=SearchHelpDialog)
