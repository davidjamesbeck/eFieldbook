# Form implementation generated from reading ui file 'ELFB/palettes/NewLexDialog.ui'
#
...
class Ui_NewLexDialog(object):
    def setupUi(self, NewLexDialog):
        ...
        self.explanation = QtWidgets.QLabel(parent=NewLexDialog)
        self.explanation.setGeometry(QtCore.QRect(35, 10, 330, 35))
        self.explanation.setObjectName("explanation")
        self.groupBox = QtWidgets.QGroupBox(parent=NewLexDialog)
        ...
        self.speakerCode = QtWidgets.QComboBox(parent=self.groupBox)
        ...
        self.researcherCode = QtWidgets.QComboBox(parent=self.groupBox)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=NewLexDialog)
        ...
        self.groupBox_2.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.ActionsContextMenu)
        ...
        self.entryWord = QtWidgets.QTextEdit(parent=self.groupBox_2)
        ...
        self.gloss = QtWidgets.QTextEdit(parent=self.groupBox_2)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=NewLexDialog)
