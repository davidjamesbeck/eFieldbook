# Form implementation generated from reading ui file 'ELFB/palettes/RecordBrowser.ui'
#
...
"}")
        ...
        self.Select = QtWidgets.QCheckBox(parent=self.groupBox)
        font = QtGui.QFont()
        ...
        self.NewList = QtWidgets.QPushButton(parent=self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setItalic(True)
        ...
        self.Save = QtWidgets.QPushButton(parent=self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setItalic(True)
        ...
        self.Discard = QtWidgets.QPushButton(parent=Dialog)
