...
def speakerTableBuilder(fldbk):
    ...
    fldbk.mSpTable.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
...
def researcherTableBuilder(fldbk):
    ...
    fldbk.mRTable.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
...
def mediaTableBuilder(fldbk):
    ...
    fldbk.mMediaTable.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
...
def egAbbreviationsBuilder(fldbk):
    ...
    fldbk.eAbbreviations.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
...
def indexAbbreviationsBuilder(fldbk):
    ...
    fldbk.iAbbreviations.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
