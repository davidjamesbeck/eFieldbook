...
class MainWindow(QMainWindow, Ui_Fieldbook):
    ...
    def __init__(self, parent=None):
        ...
        self.tAdvancedSearchBtn.setStyleSheet('background: transparent; padding: 0px; min-width: 23px; min-height: 23px;')
        self.tAdvancedSearchBtn.setIcon(AdvSearchIcon)
        self.tAdvancedSearchBtn.setIconSize(AdvSearchIconSize)
        self.eAdvancedSearchBtn.setStyleSheet('background: transparent; padding: 0px; min-width: 23px; min-height: 23px;')
        self.eAdvancedSearchBtn.setIcon(AdvSearchIcon)
        self.eAdvancedSearchBtn.setIconSize(AdvSearchIconSize)
        self.dAdvancedSearchBtn.setStyleSheet('background: transparent; padding: 0px; min-width: 23px; min-height: 23px;')
