            ...
            if event.type() == QtCore.QEvent.FocusIn:
                if dataIndex.currentTextTable != None:
                    try:
                        ...
                        dataIndex.currentTextTable.setFrameStyle(QtWidgets.QFrame.NoFrame)
                    except RuntimeError:
                        pass
                dataIndex.currentTextTable = object
                object.setFrameStyle(QtWidgets.QFrame.Box)
                object.setStyleSheet("QTableWidget QHeaderView::section {border: 0px;"
